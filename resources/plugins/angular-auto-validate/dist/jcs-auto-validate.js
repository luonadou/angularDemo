            ...
            function (validator, elementUtils) {
                var elementTypesToValidate = ['input', 'textarea', 'select', 'form'],
                    ...
                    shouldValidateElement = function (el) {
                        var elementString = elementTypesToValidate.toString(); //IE8没有arr.indexOf()方法；为支持IE8做的修改
                        return el && el.length > 0 && elementIsVisible(el) && elementString.indexOf(el[0].nodeName.toLowerCase()) > -1;
                    },
